...
-- Bay đến ĐẢO – 300 stud/s (an toàn)
...
spawn(function()
    while task.wait(0.1) do
        ...
        if bone then
            ...
            -- === Không có quái → VỀ SPAWN = SPEED 300 ===
