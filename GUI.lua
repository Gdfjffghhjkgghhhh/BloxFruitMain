...
local r = {
    Darker = {
        Colors = {
            -- Màu nền (Gradient từ trên xuống dưới)
            Background = ColorSequence.new{
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 20, 30)), -- Màu tối phía trên
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(30, 30, 50)), -- Màu giữa
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 20, 30))  -- Màu tối phía dưới
            },
            
            -- Màu chính (Nút bấm, thanh trượt, v.v...) - Đang để màu Xanh Dương
            Primary = Color3.fromRGB(0, 150, 255), 
            
            -- Màu khi di chuột vào hoặc màu phụ
            OnPrimary = Color3.fromRGB(0, 100, 200),
            
            -- Màu thanh cuộn
            ScrollBar = Color3.fromRGB(0, 120, 220),
            ...
            JoinButton = Color3.fromRGB(0, 180, 255),
            ...
            Buttons = {
                Holding = Color3.fromRGB(40, 60, 90),
                Default = Color3.fromRGB(35, 45, 70)
            },
            Border = {
                Holding = Color3.fromRGB(0, 120, 200),
                Default = Color3.fromRGB(0, 100, 180),
            },
            Text = {
            ...
            Slider = {
                SliderBar = Color3.fromRGB(0, 100, 200),
                SliderNumber = Color3.fromRGB(200, 230, 255),
            },
            Dropdown = {
                Holder = Color3.fromRGB(30, 35, 60),
            }
        },
        Icons = {
