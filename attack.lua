...
--// FastAttack Class (giữ nguyên như cũ)
local FastAttack = {}
...
--// Instance + VÔ HẠN SPAM (300x)
local AttackInstance = FastAttack.new()

-- 🔥 VÔ HẠN SPAM: RenderStepped + Stepped + Heartbeat
local SPAM_COUNT = 200-- ← CHỈNH SỐ NÀY (50 = vừa, 100 = mạnh, 200 = cực mạnh, >300 dễ lag/crash) 
...
return FastAttack  bypass ignore cho packet spam nhanh ma khong bi lam cham lai khong
